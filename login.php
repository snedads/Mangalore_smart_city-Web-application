    ...
    <section class="about contact py-lg-5 py-md-5 py-3">
        ...
        <?php include('con_db.php');
            if(isset($_POST['login']))
            {
                $email=$_POST['email'];
                $pwd=$_POST['pwd'];
                $query=mysqli_query($con,"SELECT * FROM `member` WHERE email='$email' and status='approved' and pwd='$pwd' ") or die(mysqli_error($con));
                ...
                if($num==1){
                    ...
                    echo '<script>alert("Welcome '.$fetch['mname'].'");
