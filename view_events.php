    ...
    <section class="about py-lg-5 py-md-5 py-3">
        <div class="container">
            <div class="inner-sec-wthree py-lg-5 py-3">
                <h3 class="tittle text-center"><span class="sub-tittle-w3">Featured </span>Upcoming Events</h3>
                <div class="card-deck mt-5">
                <?php include 'con_db.php';
                    $i=1; $tdate=date('Y-m-d');
                                $qry=mysqli_query($con,"SELECT * from events order by eventdate")or die(mysqli_error($con));
                       ...
                       <div class="card-body p-lg-5">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="check_partcipants.php?eid=<?php echo $row['eid']; ?>" class="btn btn-info"><i class="fa fa-eye"></i> Participants</a>         
                                <?php }else{ ?>
                             <a href="loginparticipate.php?eid=<?php echo $row['eid']; ?>" class="btn btn-warning">Participate</a>
                             <?php } ?>
                             </small>
                        </div>
                    </div>
