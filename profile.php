    ...
    <div class="container">
                ...
                <div class="col-md-10">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>Name:</td><td><?php echo $row['mname']; ?></td>
                        </tr>
                        <tr>
             ...
             <div class="row">   
                        <a href="edit_profile.php" style="margin-top: 30px; " class="btn btn-primary">Edit Profile</a> <a href="change_pwd.php" style="margin-top: 30px; " class="btn btn-success">Change Password</a>
                        <a href="memberpage.php" style="margin-top: 30px; " class="btn btn-warning">Back</a>
            </div>
    </div>
<br/>
    <!-- //contact -->
