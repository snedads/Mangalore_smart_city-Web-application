                        ...
                        <?php include('con_db.php');
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><img src="../images/<?php echo $row['image']; ?>" height="60" width="60"></td>
                                    <td><?php echo $row['edescp']; ?></td>
                                    <td><?php $posted=$row['posted_by'];
                                              if($posted=='admin')
                                              {
                                                echo 'Admin';
                                              }
                                    ...
                                    <td><a href="delete.php?eid=<?php echo $row['eid']; ?>" onclick="return confirm('Are you sure to delete it'); " class="btn btn-danger"><i class="fa fa-trash-o"></i></a> <a href="check_partcipants.php?eid=<?php echo $row['eid']; ?>"  class="btn btn-info" title="Check Participants"><i class="fa fa-eye"></i></a></td>
                                </tr>
                                <?php }?>
                    </tbody>
                </table>
