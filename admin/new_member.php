                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php include('con_db.php');
                            $i=1;
                                $qry=mysqli_query($con,"SELECT * from member where status='new' order by mname")or die(mysqli_error($con));
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="approve.php?mid=<?php echo $row['mid']; ?>" title="Approve" class="btn btn-success"><i class="fa fa-check"></i></a> <a href="reject.php?mid=<?php echo $row['mid']; ?>" title="Reject" class="btn btn-danger"><i class="fa fa-close"></i></a></td>
                                </tr>
                                <?php }?>
                    </tbody>
                </table>
