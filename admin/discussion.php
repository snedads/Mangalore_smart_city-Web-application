...
<body>
    ...
    <header class="index-banner" id="home">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">View All Discussions</li>
        </ol>
        <!---->
        <!--// banner-inner -->
                        ...
                        <?php include('con_db.php');
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="view_replies.php?lid=<?php echo $row['lid']; ?>" class="btn btn-warning" title="View reply"><i class="fa fa-eye"></i></a></td>
                                </tr>
                                <?php }?>
                    </tbody>
                </table>
