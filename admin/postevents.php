    ...
    <header class="index-banner" id="home">
        ...
        <nav class="main-header d-flex">
            <div id="brand">
                <div id="word-mark">
                    <h1>
                        <a href="adminhome.php"><span>Smart</span>City</a>
                    </h1>
                </div>
            </div>
            <div id="menu">
		...
		<form action="" method="post" enctype="multipart/form-data">
            <div class="row main">
                <div class="col-md-4 form-left">
                    <input type="text" class="top-up" name="etitle" placeholder="Event Title" required="">
                </div>
                <div class="col-md-4 form-left">
                ...
                <div class="col-md-4 form-left">
                    <input type="date" class="top-up" name="edate" min="<?php echo date('Y-m-d'); ?>" title="Event Date" placeholder="Event Date" required="">
                </div>
                <div class="col-md-8 form-left">
                    <textarea name="edescp" placeholder="Event Description" required=""></textarea>
                </div>
            ...
            if(isset($_POST['event']))
            {
                // Image storing code
                        ...
                        $edescp=$_POST['edescp'];
                                ...
                                $qry=mysqli_query($con,"INSERT INTO `events`(`etitle`, `venue`, `image`, `edescp`, `posted_by`, `id`, `postdate`, `eventdate`) VALUES ('$etitle','$venue','$final_file','$edescp','admin','1',now(),'$edate')"); 
                                if($qry)
                                {
                                    echo '<script>alert("Event Posted"); window.location="userevents.php";</script>';
                                }
                                else
                                {
                                    echo '<script>alert("Error"); window.location="postevents.php";</script>';
                                }
                        }
