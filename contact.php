...
<head>
    <title>Contact Smart City</title>
    <!-- Meta tag Keywords -->
    ...
    <section class="about contact py-lg-5 py-md-5 py-3">
        <div class="container">
            <div class="inner-sec-wthree py-lg-5 py-3">
                <h3 class="tittle text-center"><span class="sub-tittle-w3">Find us </span>Contact Us</h3>
                  <div class="row contact_grids my-lg-5 my-4 pb-lg-5 pb-3 ">
			<div class="col-md-6 text-right">
				<h5><span class="fa fa-envelope-o"></span> <a href="mailto:info@example.com">mangaloreinfo@gmail.com</a></h5>
			</div>
			<div class="col-md-6 text-left">
				<h5><span class="fa fa-phone-square"></span> +91 9988774322</h5>
			</div>
		</div>
        ...
        <?php include "con_db.php";
            if(isset($_POST['msg']))
            {
                    ...
                    $query=mysqli_query($con,"INSERT INTO `contact`(`name`, `phone`, `email`, `message`, `cdate`) VALUES ('$name','$phone','$email','$msg',now())")or die(mysqli_error($con));
                            if($query==true)
                            {
                    
                                echo '<script>alert("Thank you, Your Feedback is Sent");window.location="index.php";</script>';
                            }
                            else
                            {
