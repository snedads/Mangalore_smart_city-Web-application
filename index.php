...
<body>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item item3">
                        <div class="carousel-caption">
                            <h3>Clean city makes us proud</h3>
                        </div>
                    </div>
                </div>
            ...
            <div class="inner-sec-wthree py-lg-5 py-3">
                <div class="row">
                    <div class="col-lg-6 about-right px-lg-5 px-2 mt-lg-5 mt-2">
                        ...
                        <h3 class="tittle"><span class="sub-tittle-w3">About</span>Hi There!!!</h3>
                        <p class="my-4 text-justify">Mangalore, officially known as Mangaluru, is the chief port city of the Indian state of Karnataka. It is located about 352 km (219 mi) west of the state capital, Bangalore, between the Arabian Sea and the Western Ghats mountain range. It is the second major city in Karnataka state in all aspects after the capital city Bangalore. It is the only city in Karnataka to have all modes of transport — Air, Road, Rail and Sea along with 5 other major cities in India. It is also known as the Gateway of Karnataka. It is the largest city in the Tulu Nadu region of Karnataka. Mangalore is the second best business destination in Karnataka after Bangalore & 13th best in India. The population of the urban agglomeration was 623,841, according to the provisional results of the 2011 national census of India</p>
                        
                         
                       
                    </div>
                    <div class="col-lg-6 about-img">
                        <img src="images/Mangalore_City.jpg" class="img-fluid" alt="user-image">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="login px-4 mx-auto mw-100 gal-img pb-3">
                        <img class="img-fluid col-md-12" src="images/g1.jpg">
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pb-3">
                    <div class="login px-4 mx-auto mw-100 gal-img pb-3">
                        <img class="img-fluid col-md-12" src="images/g2.jpg">
                    </div>
                </div>
    ...
    <div class="modal fade" id="exampleModalCenter7" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pb-3">
                    <div class="login px-4 mx-auto mw-100 gal-img pb-3">
                        <img class="img-fluid col-md-12" src="images/g3.jpg">
                    </div>
                </div>
    ...
    <div class="modal fade" id="exampleModalCenter8" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pb-3">
                    <div class="login px-4 mx-auto mw-100 gal-img pb-3">
                        <img class="img-fluid col-md-12" src="images/g4.jpg">
                    </div>
                </div>
    ...
    <div class="modal fade" id="exampleModalCenter9" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pb-3">
                    <div class="login px-4 mx-auto mw-100 gal-img pb-3">
                        <img class="img-fluid col-md-12" src="images/g9.jpg">
                    </div>
                </div>
    ...
    <div class="modal fade" id="exampleModalCenter10" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pb-3">
                    <div class="login px-4 mx-auto mw-100 gal-img pb-3">
                        <img class="img-fluid col-md-12" src="images/g5.jpg">
                    </div>
                </div>
    ...
    <div class="modal fade" id="exampleModalCenter11" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pb-3">
                    <div class="login px-4 mx-auto mw-100 gal-img pb-3">
                        <img class="img-fluid col-md-12" src="images/g7.jpg">
                    </div>
                </div>
    ...
    <div class="modal fade" id="exampleModalCenter12" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pb-3">
                    <div class="login px-4 mx-auto mw-100 gal-img pb-3">
                        <img class="img-fluid col-md-12" src="images/g8.jpg">
                    </div>
                </div>
    ...
    <div class="modal fade" id="exampleModalCenter13" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pb-3">
                    <div class="login px-4 mx-auto mw-100 gal-img pb-3">
                        <img class="img-fluid col-md-12" src="images/g6.jpg">
                    </div>
                </div>
    ...
    <section class="about py-lg-5 py-md-5 py-3">
        <div class="container">
            <div class="inner-sec-wthree py-lg-5 py-3">
                <h3 class="tittle text-center"><span class="sub-tittle-w3">Upcoming </span>3 Events</h3>
                <div class="card-deck mt-5">
                <?php include 'con_db.php';
                    $i=1; $tdate=date('Y-m-d');
                                $qry=mysqli_query($con,"SELECT * from events")or die(mysqli_error($con));
                                while ($row=mysqli_fetch_array($qry)){
                 ?>
                    <div class="card">
                        <img class="card-img-top" src="images/<?php echo $row['image']; ?>" height="220" width="300" alt="<?php echo $row['etitle']; ?>">
                       <div class="card-body p-lg-5">
                            <h5 class="card-title"><?php echo $row['etitle']; ?></h5>
                            <p class="card-text"><?php echo $row['edescp'].' .Event is on '.date('d-m-Y',strtotime($row['eventdate'])); ?></p>
                        </div>
                        <div class="card-footer">
                            <small class="text-muted">Posted on <?php echo date('d-m-Y',strtotime($row['postdate'])); ?>
                             <a href="participate.php?eid=<?php echo $row['eid']; ?>" class="btn btn-warning">Participate</a>
                             </small>
                        </div>
                    </div>
                 <?php } ?>   
