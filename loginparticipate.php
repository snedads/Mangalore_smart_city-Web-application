...
<body>
    ...
    <header class="index-banner" id="home">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Participate in Event</li>
        </ol>
        <!---->
        <!--// banner-inner -->
    ...
    <section class="about contact py-lg-5 py-md-5 py-3">
        ...
        <?php include('con_db.php');
            if(isset($_POST['part']))
            {
                ...
                $sql=mysqli_query($con,"SELECT * FROM  participants where eid='$eid' and name='$name' and email='$email' and contact='$contact'");
                $nums=mysqli_num_rows($sql);
                if($nums==0)
                {
                        $qry=mysqli_query($con,"INSERT INTO `participants`(`eid`, `name`, `contact`, `email`) VALUES ('$eid','$name','$contact','$email')"); 
                        if($qry)
                        {
                        ...
                        {
                            echo '<script>alert("Error"); window.location="participate.php";</script>';
                        }
                }
                else
                {
                    echo '<script>alert("You have already registered for the event"); window.location="participate.php";</script>'; 
                }
            }
         ?>
            </div>
