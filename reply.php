...
<body>
    ...
    <div class="container">
        <div class="row">
             ...
             <div class="col-md-4">
                 <form action="insert.php?lid=<?php echo $lid;?>" method="post">
                   <div class="form-group">
                     <textarea class="form-control" name="content" placeholder="Reply"></textarea>
                   </div>
                     <input type="submit" class="btn btn-success" name="reply">
                 </form><br/><br/>
             </div>
        </div>
    </div> 
