                       ...
                       <div class="card-body p-lg-5">
                        ...
                        <div class="card-footer">
                            <small class="text-muted">Posted on <?php echo date('d-m-Y',strtotime($row['postdate'])); ?>
                             <?php $posted=$row['posted_by']; $id=$row['id'];
                                if($posted==$mname && $id==$mid)
                                    { ?>
                            <a href="check_partcipants.php?eid=<?php echo $row['eid']; ?>" class="btn btn-info"><i class="fa fa-eye"></i> Participants</a>         
                                <?php }else{ ?>
