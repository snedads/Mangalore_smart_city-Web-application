    ...
    <section class="about contact py-lg-5 py-md-5 py-3">
		...
		<form action="" method="post" enctype="multipart/form-data">
			<div class="row main">
				...
				<div class="col-md-4 form-left">
					<input type="password" name="pwd" placeholder="Current Password" required="">
				</div>
                ...
                <div class="col-md-4 form-left">
                    <input type="password" name="cpwd" placeholder="Re-Enter Password" required="">
                </div>
                <div class="col-md-4 form-right">
                </div>
                <div class="col-md-4 form-left">
        ...
        <?php include('con_db.php');
            if(isset($_POST['change']))
            {
                ...
                $npwd=$_POST['npwd'];
                $rpwd=$_POST['cpwd'];
                $sql=mysqli_query($con,"select * from member where pwd='$opwd' and mid='$mid'")or die(mysqli_error($con));
                $nrows=mysqli_num_rows($sql);
                if($nrows==1)
                {
                    if($npwd==$rpwd)
                    {
                        $qry=mysqli_query($con,"update member set pwd='$npwd' where mid='$mid'"); 
                        if($qry)
                        {
                            echo '<script>alert("Password Changed"); window.location="memberpage.php";</script>';
                        }
                        else
                        {
                            echo '<script>alert("Error"); window.location="change_pwd.php";</script>';
                        }
                    }
                    else
                    {
                        echo '<script>alert("Password Missmatch"); window.location="change_pwd.php";</script>';
                    }
                }
            }
         ?>
