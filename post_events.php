            ...
            if(isset($_POST['event']))
            {
                // Image storing code
                        ...
                        $edescp=$_POST['edescp'];
                                ...
                                $qry=mysqli_query($con,"INSERT INTO `events`(`etitle`, `venue`, `image`, `edescp`, `posted_by`, `id`, `postdate`, `eventdate`) VALUES ('$etitle','$venue','$final_file','$edescp','$mname','$mid',now(),'$edate')"); 
                                if($qry)
                                {
                                    echo '<script>alert("Event Posted"); window.location="view_events.php";</script>';
                                }
                                else
                                {
                                    echo '<script>alert("Error"); window.location="post_events.php";</script>';
                                }
                        }
